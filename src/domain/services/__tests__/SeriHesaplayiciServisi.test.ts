...
describe('SeriHesaplayiciServisi Unit Testleri', () => {
  ...
  const tamNamazlar = (tarih: string): GunlukNamazlar => ({
    ...
    namazlar: [
      ...
      { namazAdi: 'Ogle', tamamlandi: true, tarih },
      { namazAdi: 'Ikindi', tamamlandi: true, tarih },
      { namazAdi: 'Aksam', tamamlandi: true, tarih },
      { namazAdi: 'Yatsi', tamamlandi: true, tarih },
    ],
  });
  ...
  const eksikNamazlar = (tarih: string): GunlukNamazlar => ({
    ...
    namazlar: [
      { namazAdi: 'Sabah', tamamlandi: true, tarih },
      { namazAdi: 'Ogle', tamamlandi: false, tarih },
      { namazAdi: 'Ikindi', tamamlandi: true, tarih },
      { namazAdi: 'Aksam', tamamlandi: false, tarih },
      { namazAdi: 'Yatsi', tamamlandi: true, tarih },
    ],
  });
